...
public class UploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.upload_activity_selected_image);
    }
    ...
    //startActivityForResulttan sonra yapılacaklar
    @Override
    ...
    public void upload(View view) {
        ...
        final ParseObject object = new ParseObject("Posts");
        object.put("image", parseFile);
        object.put("comment", commText);
